(function ($, root, undefined) {
    $(function () {
        ...
        dragElement(document.getElementById("subscribeWindow"));
        dragElement(document.getElementById("musicWindow"));
        dragElement(document.getElementById("videosWindow"));
        dragElement(document.getElementById("screensaverWindow"));
        dragElement(document.getElementById("tourWindow"));
